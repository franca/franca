...
class CodeGeneratorTest extends XtextTest {
	...
	def loadModel(String fileToTest, String... referencedResources) {
	...
	/** 
	 * Asserts that France generates a TypeCollectionPropertyAccessor 
	...
	def void test_40_DefTypeCollection() {
		...
		*/
		...
		assertTrue("No class for " + nameOfTheClassUnderTest, expectedJavaClasses.contains(nameOfTheClassUnderTest))
